...
К этому моменту должна быть развернута и настроена desktop-версия или web-версия WT-программы. Процессу развертывания desktop-версии посвящена статья [Развертывание проекта](./), а web-версии - статья [Добавление web-приложения](adding_web-app.md).
