...
{% hint style="info" %}
Desktop-версия и web-версия WT-приложения не обязательно должны быть реализовани вместе - они могут заменять друг друга. А могут дополнять функционал и расширять возможности. Например, web-приложение для реализации личного кабинате или онлайн заказов товаров и услуг.

В рамках учебного проекта можете выбрать одину из версий WT-приложения и пройти практический курс по реализации полноценного клиент-серверного приложения.
{% endhint %}
