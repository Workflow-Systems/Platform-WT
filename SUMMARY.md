...
* [Workflow Technology](README.md)

## Описание платформы <a href="#platform-description" id="platform-description"></a>

* [Основы платформы](platform-description/platform-basics.md)
* [Что такое lightcode](platform-description/what-is-lightcode.md)
* [Архитектура платформы](platform-description/platform-architecture.md)
* [Архитектура проекта](platform-description/project-architecture.md)

## Настройка среды разработки <a href="#setting-up-dev-environment" id="setting-up-dev-environment"></a>

* [Учебный проект](setting-up-dev-environment/educational-project.md)
